    ...
    <div class="auto-container">
        ...
        <div class="single-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
            <div class="team-block-one">
                <div class="inner-box">
                    <figure class="image-box"><img src="{{asset('frontend/assets/images/team/team-1.jpg')}}" alt="team1"></figure>
            ...
            <div class="team-block-one">
                <div class="inner-box">
                    <figure class="image-box"><img src="{{asset('frontend/assets/images/team/team-2.jpg')}}" alt="team2"></figure>
                    <div class="lower-content">
                        <div class="inner">
            ...
            <div class="team-block-one">
                <div class="inner-box">
                    <figure class="image-box"><img src="{{asset('frontend/assets/images/team/team-3.jpg')}}" alt="team3"></figure>
                    <div class="lower-content">
                        <div class="inner">
            ...
            <div class="team-block-one">
                <div class="inner-box">
                    <figure class="image-box"><img src="{{asset('frontend/assets/images/team/team-4.jpg')}}" alt="team4"></figure>
                    <div class="lower-content">
                        <div class="inner">
            ...
            <div class="team-block-one">
                <div class="inner-box">
                    <figure class="image-box"><img src="{{asset('frontend/assets/images/team/team-5.jpg')}}" alt="team5"></figure>
                    <div class="lower-content">
                        <div class="inner">

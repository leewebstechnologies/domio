                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>
                                    <img src="{{ asset($item->main_thumbnail) }}" style="width: 70px; height: 40px;" />
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('details.property', $item->id) }}" class="btn btn-inverse-info" title="Detail"><i data-feather="eye"></i></a>
